<?php
    ...
    // Comprobamos que el id sea un int
    ...
    // Si estamos aquí, recogemos el juego
    $game = getGameById($data['id']);

    if ($game === null) {
        http_response_code(404); // Not Found
        echo json_encode(["message" => "No se ha encontrado el juego con ese id"]); // Deberíamos redirigir al formulario y dar feedback
        exit;
    }
